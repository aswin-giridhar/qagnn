...
from utils.arcnet import extract_english, construct_graph
...
output_paths = {
    'arc': {
        ...
        'graph': {
            'train': './data/arc/graph/train.graph.jsonl',
            'dev': './data/arc/graph/dev.graph.jsonl',
            'test': './data/arc/graph/test.graph.jsonl',
        },
    },
    'arcnet': {
        'csv': './data/arcnet/arcnet.en.csv',
        'vocab': './data/arcnet/concept.txt',
        'patterns': './data/arcnet/matcher_patterns.json',
        'unpruned-graph': './data/arcnet/arcnet.en.unpruned.graph',
        'pruned-graph': './data/arcnet/arcnet.en.pruned.graph',
    },
    'cpnet': {
...
def main():
    ...
    parser.add_argument('--run', default=['common'], choices=['arcnet','arc','common', 'csqa', 'hswag', 'anli', 'exp', 'scitail', 'phys', 'socialiqa', 'obqa', 'obqa-fact', 'make_word_vocab'], nargs='+')
    ...
    routines = {
        ...
        'arcnet': [
            {'func': extract_english, 'args': (input_paths['arcnet']['csv'], output_paths['arcnet']['csv'], output_paths['arcnet']['vocab'])},
            {'func': construct_graph, 'args': (output_paths['arcnet']['csv'], output_paths['arcnet']['vocab'],
                                               output_paths['arcnet']['unpruned-graph'], False)},
            {'func': construct_graph, 'args': (output_paths['arcnet']['csv'], output_paths['arcnet']['vocab'],
                                               output_paths['arcnet']['pruned-graph'], True)},
            {'func': create_matcher_patterns, 'args': (output_paths['arcnet']['vocab'], output_paths['arcnet']['patterns'])},
        ],
        'arc': [
	        ...
	        {'func': ground, 'args': (output_paths['arc']['statement']['train'], output_paths['arcnet']['vocab'],
                                      output_paths['arcnet']['patterns'], output_paths['arc']['grounded']['train'], args.nprocs)},
	        {'func': ground, 'args': (output_paths['arc']['statement']['dev'], output_paths['arcnet']['vocab'],
                                      output_paths['arcnet']['patterns'], output_paths['arc']['grounded']['dev'], args.nprocs)},
            {'func': ground, 'args': (output_paths['arc']['statement']['test'], output_paths['arcnet']['vocab'],
                                      output_paths['arcnet']['patterns'], output_paths['arc']['grounded']['test'], args.nprocs)},
	        {'func': generate_adj_data_from_grounded_concepts__use_LM, 'args': (output_paths['arc']['grounded']['train'], output_paths['arcnet']['pruned-graph'], output_paths['arcnet']['vocab'], output_paths['arc']['graph']['train'], args.nprocs)},
            {'func': generate_adj_data_from_grounded_concepts__use_LM, 'args': (output_paths['arc']['grounded']['dev'], output_paths['arcnet']['pruned-graph'], output_paths['arcnet']['vocab'], output_paths['arc']['graph']['dev'], args.nprocs)},
            {'func': generate_adj_data_from_grounded_concepts__use_LM, 'args': (output_paths['arc']['grounded']['test'], output_paths['arcnet']['pruned-graph'], output_paths['arcnet']['vocab'], output_paths['arc']['graph']['test'], args.nprocs)},
        ],
        'csqa': [
